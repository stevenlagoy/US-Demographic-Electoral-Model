...
#define STARTING_TEMPERATURE 0.50
#define TEMPERATURE_STEP 0.000001 // 0.0000001 or 0.0000005
// f(x) = -TEMPERATURE_STEP * x + STARTING_TEMPERATURE

#define CHANGE_DESCRIPTOR_EFFECT_CHANCE 0.0
#define CHANGE_COUNTY_MEMBERSHIP_CHANCE 1.0 - CHANGE_DESCRIPTOR_EFFECT_CHANCE

#define ADD_REMOVE_BORDER_COUNTY_CHANCE 1.0
...
// Score weights
#define ACCURACY_SCORE_WEIGHT    0.0 //0.500
#define SPECIFICITY_SCORE_WEIGHT 0.0 //0.100
#define PARSIMONY_SCORE_WEIGHT   0.0 //0.025
#define LOCALITY_SCORE_WEIGHT    1.0 //0.375
